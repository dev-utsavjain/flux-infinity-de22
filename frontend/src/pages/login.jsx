            ...
            <div className="bg-[#0A0A0B] border border-white/10 rounded-2xl p-8 backdrop-blur-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-2">
                    <input type="checkbox" className="w-4 h-4 rounded border-white/20 bg-transparent text-[#5E6AD2] focus:ring-[#5E6AD2]" />
                    <span className="text-sm text-white/60">Remember me</span>
                  </label>
                  <Link to="/forgot-password" className="text-sm text-[#5E6AD2] hover:text-[#5E6AD2]/80">Forgot password?</Link>
                </div>
              ...
              <div className="mt-8 text-center">
                <p className="text-white/60">
                  ...
                  <Link to="/signup" className="text-[#5E6AD2] hover:text-[#5E6AD2]/80 font-medium">Sign up</Link>
                </p>
              </div>
            </div>
          </div>
